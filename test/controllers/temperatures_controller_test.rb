...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { celcius: @temperature.celcius, farenhiet: @temperature.farenhiet, temp_time: @temperature.temp_time }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { celcius: @temperature.celcius, farenhiet: @temperature.farenhiet, temp_time: @temperature.temp_time }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
